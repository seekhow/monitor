...
var Record=function(){
    ...
    var _showdata=function(){
        var userid =document.getElementById("oneuser").title;//alert(userid);
        $.post("adminshow_oneuserServletAction?user_id="+userid,function(data){
            var html="";
            //alert(12345);
            var json=eval("("+data+")");
...
//up check
    var upcheck=function(){//alert(11111);
        var userid =document.getElementById("oneuser").title;//alert(userid);
        $.post("upcheck_userServletAction?user_id="+userid,function(data){
            var html="";
           // alert(12345);
            var json=eval("("+data+")");
            var list=json.aaData;
            ...
            //var newid = list[0][5];
            document.getElementById("oneuser").innerHTML=html;
            document.getElementById("oneuser").title=list[0][5];
        });
    };
    //down check
    var downcheck=function(){//alert(11111);
        var userid =document.getElementById("oneuser").title;//alert(userid);
        $.post("downcheck_userServletAction?user_id="+userid,function(data){
            var html="";
            // alert(12345);
            var json=eval("("+data+")");
            var list=json.aaData;
    ...
    return{
        ...
        upcheck:function(post_id){
            upcheck(post_id);
        },
        downcheck:function(post_id){
            downcheck(post_id);
        },
