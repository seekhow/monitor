                ...
                <div class="col-sm-12">
                    ...
                    <div class="nest" id="FootableClose">
                        ...
                        <div class="body-nest" id="Footable" >
                            ...
                            <p class="lead well">用户可以在这个页面，修改设备信息</p>
                            <!-- BEGIN PAGE CONTENT-->
                            <!-- ----------------------------------------页面开始，替换这里即可---------------------------------------- -->
                            <!-- 查询数据库 -->
                            <div class="row">
                                            ...
                                            <form class="form-horizontal" role="form" id="page_form" name="page_form" action="device_modify_ok.jsp">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="device_id" name="device_id" class="form-control" value=" "/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">车牌号</label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="device_name" name="device_name" class="form-control" value=" "/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">车主</label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="device_host" name="device_host" class="form-control" value=" "/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">使用状态</label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="device_status" name="device_status" class="form-control" value=" "/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
...
<script type="text/javascript" src="device/js/device_modify.js"></script>
