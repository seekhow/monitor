                                            ...
                                            <form class="form-horizontal" role="form" id="page_form" name="page_form">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="col-md-3 control-label">设备ID（必填）*</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="col-md-3 control-label">使用状态(只能输入1或0，表示正常或异常)</label>
                                                ...
                                                <div class="form-actions right1">
                                                    ...
                                                    <button type="button" id="add_button" class="btn green"  onclick="Record.addRecord();">
