 ...
 */
public class downcheck_userServletAction extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{
        ...
        try {
            ...
            // String sql="select * from user_file where user_id like '%"+ user_id+"%'";

            String sql = "select * from user_file order by id<='"+ user_id+"',id asc limit 1";
