...
//	    String deviceName=request.getParameter("device_name");
	    ...
	    String addTime =request.getParameter("add_time");
			...
			try {
				...
				String sql = "update user_file set user_id='" + user_Id+ "',user_name='" + userName + "',user_gender='" + userGender + "',user_password='" + userPassword + "' ,add_time='" + addTime + "'where id=" + id;
		...
		%>
更改成功！请返回。
<input type="button" name="listBtn" value="返回列表" onclick="window.self.location='user.jsp'">
		<%
			} catch (SQLException sqlexception) {
				sqlexception.printStackTrace();
		%>
出现错误，请查看Console提示信息！请返回。
<input type="button" name="listBtn" value="返回列表" onclick="window.location='user.jsp'">
		<%
			}
		%>
							</div>
...
ss
    ...
    <script src="project/js/jquery-1.8.3.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="project/js/record_list_add.js"></script>
